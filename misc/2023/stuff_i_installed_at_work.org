...
** set is like "object strict". So same objects will not be shown
...
123
:asd
** set treats everything like real objects. So, it has methods like .union(), .intersection(), .difference()
**
...
===== can do the same with geometry_set
