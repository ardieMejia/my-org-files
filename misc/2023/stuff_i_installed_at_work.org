...
** CRS
*** The CRS choice (geospatial reference system), should be flexible, and can be varies from user to user, and depends on specific use-cases
** SDK
*** uses Python 
*** entry point alteia.sdk.SDK
#+begin_quote
