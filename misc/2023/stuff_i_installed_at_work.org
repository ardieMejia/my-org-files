...
#+end_src
* Please write in task 19 about defining all the styles in l_style_holder. A single variables holding many custom defined text style and image scheme, to attacah to a single tree_item. So in theory, good management is having many styles inside a tree_item
** 
