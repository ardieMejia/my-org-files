...
[[./Git/git-reset.png]]
* Git history manips:
** [[https://community.latenode.com/t/how-to-upload-only-the-latest-commit-to-github-without-previous-history/35267/6][an orphan commit is a great way to clean history, like in our example that has our DB passwords]]
*** We can also do this with worktree, YAYYYYY!!
...
** We are trying to make codeberg, Stupid piece of command, I hate Git now
** [[https://gist.github.com/JonasGroeger/4393203cc846da558fec1531cdd822db][storing your credentials in libsecret]]
